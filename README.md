...
- **Bootstrap CI option**: `--ci-method bootstrap` runs case-resampling refit per replicate as an alternative to the parametric Monte-Carlo CI, with parallelized inner loop
